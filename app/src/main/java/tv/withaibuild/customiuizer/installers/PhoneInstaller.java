...
import tv.withaibuild.customiuizer.mods.utils.feature.PhoneFeatures;
import tv.withaibuild.customiuizer.utils.PrefMap;

/**
 * Installer for hooks that run in the Phone process.
 *
...
public final class PhoneInstaller {
    ...
    public static void install(PackageReadyParam lpparam, PrefMap mPrefs) {
        ...
        for (FeatureDefinition feature : PhoneFeatures.all(lpparam, mPrefs)) {
